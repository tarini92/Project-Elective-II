...
#### REFERENCE LINK: https://github.com/Hvass-Labs/TensorFlow-Tutorials
...
data_dir = "C:\\Users\\Akanksha\\Desktop\\Sem III\\ML PE\\MOT\\Codes\\inception\\"

# File containing the mappings between class-number and uid. (Downloaded)
path_uid_to_cls = "imagenet_2012_challenge_label_map_proto.txt"
...
class NameLookup:
    ...
    def __init__(self):
        ...
        #print(os.path.exists("C:\\Users\\Akanksha\\Desktop\\SemIII\\MLPE\\MOT\\Codes\\inception\\imagenet_synset_to_human_label_map.txt"))
        #print(path)
        with open(file=path, mode='r') as file:
            # Read all lines from the file.
            lines = file.readlines()
...
if __name__ == '__main__':
    ...
    image_paths = glob.glob("C:/Users/Akanksha/Desktop/Sem III/ML PE/MOT/MOT Dataset/2DMOT2015/2DMOT2015/train/ADL-Rundle-6/img1/*.jpg")
    ...
    # Storing the transfer values from the next to last layer(pool layer) as feature vectors
    
    transfer_values_train = []
    i=1
    for path in image_paths:
        print("Computing feature vectors for image: %d"% i)
        transfer_values_train.append(model.transfer_values(path))
        i += 1
    
    transfer_values_train = np.asarray(transfer_values_train)
    print(transfer_values_train.shape)
    print("Writing to the file...")
    np.savetxt('features.out', transfer_values_train, delimiter=',')    
